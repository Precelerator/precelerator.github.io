...
export default function PrivacyPolicy() {
  return (
    <Layout home={false}>
      <SiteHeader heading="Datenschutzerklärung"></SiteHeader>
      <TextContainer>
        <h3>Allgemein</h3>
        <p>
          Wir freuen uns sehr über Ihr Interesse an der Arbeit und den Angeboten
          des Strascheg Centers. Datenschutz hat einen besonders hohen
          Stellenwert für uns. Die Nutzung mancher Services unserer Website
          www.sce.de ist nicht ohne Angabe personenbezogener Daten möglich.
          Sofern Sie solche Services unseres Unternehmens über unsere
          Internetseite in Anspruch nehmen möchten, könnte die Verarbeitung
          personenbezogener Daten erforderlich werden.
        </p>
        <p>
          Die Verarbeitung personenbezogener Daten, wie Name, Anschrift oder
          E-Mail-Adresse einer betroffenen Person, erfolgt stets im Einklang mit
          der Datenschutz-Grundverordnung und in Übereinstimmung mit den
          geltenden deutschen Datenschutzbestimmungen. Mittels dieser
          Datenschutzerklärung möchten wir Sie über Art, Umfang und Zweck der
        ...
        <p>
          Das Strascheg Center möchte einen lückenlosen Schutz der über diese
          ...
          Sicherheitslücken aufweisen, sodass ein 100% Schutz im Grundsatz nicht
          gewährleistet werden kann. Aus selbigen Grund steht es Ihnen und jeder
          betroffenen Person frei, personenbezogene Daten auch auf alternativen
          Wegen an uns zu übermitteln, z.B mündlich oder telefonisch.
        </p>
        <p>
        ...
        <p>
          Strascheg Center for Entrepreneurship (SCE) Heß-Straße 89 80797
          München Deutschland
        </p>
        <p>Telefon: +49 89 55 05 06 0 E-Mail: datenschutz@sce.de</p>
        <p>
        ...
        <strong>Gesetzlich vorgeschriebener Datenschutzbeauftragter</strong>
        <p>
          Wir haben für unser Unternehmen einen Datenschutzbeauftragten
          bestellt.
        </p>
        <p>
          Datenschutzbeauftragte/r am Strascheg Center for Entrepreneurship
          (SCE) Heß-Str. 89 80797 München Deutschland
        </p>
        <p>Telefon: +49 89 5505060 E-Mail: datenschutz@sce.de</p>
        ...
        <p>
          ...
          des Dienstes zu ermöglichen oder abzurechnen. Die erhobenen
