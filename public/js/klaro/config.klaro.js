    ...
    if (
      (function (e) {
        ...
        for (i = 0; i < n.length; i++) {
          if ((t = n[i].split('='))[0].replace(/^\s+|\s+$/g, '') == e)
            return (
              (c = !0),
              t.length > 1 && (o = unescape(t[1].replace(/^\s+|\s+$/g, ''))),
              o
            );
          t = null;
        }
      ...
      (n = n || document.domain), (t = t || '/');
      document.cookie =
        e + '=; expires=' + new Date() + '; domain=' + n + '; path=' + t;
    }
  } catch (e) {}
}
function zzglCookieTextDe() {
  setTimeout(function () {
    let isactive = document.querySelector('div.klarodesc');
    if (!isactive) {
      let parentklaro = document.querySelector(
        'div#app-item-klaro-description',
      );
      if (parentklaro) {
        var klarozzgltext = document.createElement('div');
        klarozzgltext.className = 'klarodesc';
        klarozzgltext.innerHTML =
          "<div class='klaro-moreinfo'>Mehr Infos</div><table style='display: none;'><tbody><tr><td><strong><small>Cookie Name</small></strong></td><td><small>klaro</small></td></tr><tr><td><strong><small>Host(s)</small></strong></td><td><small>." +
          domainName +
          "</small></td></tr><tr><td><strong><small>Aufbewahrung</small></strong></td><td><small>7 Tage</small></td></tr><tr><td><strong><small>Funktion</small></strong></td><td><small>Speichert Ihre Einwilligung zur Verwendung von Cookies.</small></td></tr><tr class='klaro-hr'><td colspan='2'></td></tr></tbody></table>";
        parentklaro.appendChild(klarozzgltext);
      }
      let parentgoogleanalytics = document.querySelector(
        'div#app-item-googleanalytics-description',
      );
      if (parentgoogleanalytics) {
        var klarozzgltext = document.createElement('div');
        klarozzgltext.className = 'klarodesc';
        klarozzgltext.innerHTML =
          "<div class='klaro-moreinfo'>Mehr Infos</div><table style='display: none;'><tbody><tr><td><strong><small>Cookie Name</small></strong></td><td><small>_ga</small></td></tr><tr><td><strong><small>Anbieter</small></strong></td><td><small>Google LLC</small></td></tr><tr><td><strong><small>Aufbewahrung</small></strong></td><td><small>2 Jahre</small></td></tr><tr><td><strong><small>Funktion</small></strong></td><td><small>Cookie von Google für Website-Analysen. Erzeugt statistische Daten darüber, wie der Besucher die Website nutzt.</small></td></tr><tr class='klaro-hr'><td colspan='2'></td></tr><tr><td><strong><small>Cookie Name</small></strong></td><td><small>_gid</small></td></tr><tr><td><strong><small>Anbieter</small></strong></td><td><small>Google LLC</small></td></tr><tr><td><strong><small>Aufbewahrung</small></strong></td><td><small>1 Tag</small></td></tr><tr><td><strong><small>Funktion</small></strong></td><td><small>Zählt und verfolgt Seitenaufrufe</small></td></tr><tr class='klaro-hr'><td colspan='2'></td></tr><tr><td><strong><small>Cookie Name</small></strong></td><td><small>_gat</small></td></tr><tr><td><strong><small>Anbieter</small></strong></td><td><small>Google LLC</small></td></tr><tr><td><strong><small>Aufbewahrung</small></strong></td><td><small>1 Min</small></td></tr><tr><td><strong><small>Funktion</small></strong></td><td><small>Anfragen von Bots filtern</small></td></tr><tr><td colspan='2'><small><p>Weitere Informationen finden Sie unter&nbsp;<a href='https://policies.google.com/privacy' target='_blank'>https://policies.google.com/privacy</a></p></small></td></tr><tr class='klaro-hr'><td colspan='2'></td></tr></tbody></table>";
        parentgoogleanalytics.appendChild(klarozzgltext);
      }
    }
    ...
    if (!isactive) {
      ...
      if (parentklaro) {
        ...
        klarozzgltext.innerHTML =
          "<div class='klaro-moreinfo'>Mehr Infos</div><table style='display: none;'><tbody><tr><td><strong><small>Cookie Name</small></strong></td><td><small>klaro</small></td></tr><tr><td><strong><small>Host(s)</small></strong></td><td><small>." +
          domainName +
          "</small></td></tr><tr><td><strong><small>Retention</small></strong></td><td><small>7 Days</small></td></tr><tr><td><strong><small>Function</small></strong></td><td><small>Saves your consent to the use of cookies.</small></td></tr><tr class='klaro-hr'><td colspan='2'></td></tr></tbody></table>";
        parentklaro.appendChild(klarozzgltext);
      }
      let parentgoogleanalytics = document.querySelector(
        'div#app-item-googleanalytics-description',
...
function klaroLoadScript(elementName) {
  var klaroScript = document.querySelectorAll(
...
window.onload = function () {
  ...
  var strPageToHidden =
    'agb,terms_conditions,impressum,imprint,datenschutz,privacy_policy,privacy-policy';
...
var klaroConfig = {
  ...
  translations: {
    de: {
      consentModal: {
        title:
          'Ihre Cookie-Präferenzen – entscheiden Sie, was Sie mit uns teilen',
        description:
